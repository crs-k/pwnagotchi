...
source "arm" "rpi64-pwnagotchi" {
  ...
  qemu_binary_source_path       = "qemu-aarch64-static"
  qemu_binary_destination_path  = "qemu-aarch64-static"
...
source "arm" "rpi32-pwnagotchi" {
  ...
  qemu_binary_source_path       = "qemu-arm-static"
  qemu_binary_destination_path  = "qemu-arm-static"
  image_build_method            = "resize"
  image_size                    = "9G"
  image_type                    = "dos"
  image_partitions {
