...
class Waveshare352(DisplayImpl):
    def __init__(self, config):
        super(Waveshare352, self).__init__(config, 'waveshare3in52')
        self._display = None
    ...
    def initialize(self):
            ...
            logging.info("initializing waveshare v3in52 display in monochromatic mode")
